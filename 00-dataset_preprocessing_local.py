...
# Cleans raw JSONL data (e.g., forum questions/replies) and 
# converts it to Alpaca format (instruction/input/output). 
# It handles text cleaning, vehicle details extraction, and 
